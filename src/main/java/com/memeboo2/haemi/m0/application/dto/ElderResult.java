...
public record ElderResult(UUID elderId, UUID groupId, UUID memberId, String name, int birthYear, Gender gender,
    ...
    public static ElderResult from(Elder elder, boolean hasHealthInformation, double completeness) {
        return new ElderResult(elder.getId(), elder.getGroupId(), elder.getMemberId(), elder.getName(), elder.getBirthYear(),
