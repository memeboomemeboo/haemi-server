...
public record ElderResult(UUID elderId, UUID groupId, UUID elderMemberId, String name, int birthYear, Gender gender,
    ...
    public static ElderResult from(Elder elder, boolean hasHealthInformation, double completeness) {
        return new ElderResult(elder.getId(), elder.getGroupId(), elder.getElderMemberId(), elder.getName(), elder.getBirthYear(),
